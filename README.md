# Formula 1 Tire Degradation and Speed Analysis Tool

**Live app:** https://f1-telemetry-tool.streamlit.app/

A web tool for comparing two drivers within a single Formula 1 race across three dimensions: fastest-lap speed traces, the time gap between them around the lap, and how quickly their tires degrade by compound. Built with Python, FastF1, Plotly, and Streamlit.
